...
nproc_per_node=8
project_name=numina80k-indomain-v3

experiment_name=numina80k-indomain-v3-qwen-2.5-7B-instruct
save_path=/mnt/vast/data/miaosen/lys/checkpoints/$experiment_name

torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
        -m verl.trainer.fsdp_indomain_v3_trainer \
    ...
    model.indomain_clip_B=10.0 \
    model.indomain_alpha_max=1.0 \
    model.indomain_alpha_min=0.1 \
