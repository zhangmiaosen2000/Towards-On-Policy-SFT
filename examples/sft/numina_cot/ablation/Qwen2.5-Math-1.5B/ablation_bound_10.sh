...
nproc_per_node=8
project_name=ablation-polylog

experiment_name=ablation-qwen-2.5-math-1.5B-bound-10.0
save_path=/mnt/vast/data/miaosen/lys/final_checkpoints/ablation/$experiment_name

torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
        -m verl.trainer.fsdp_polylog_ablation_trainer \
